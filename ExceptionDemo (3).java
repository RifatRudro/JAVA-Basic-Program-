...
public class ExceptionDemo {
	...
	public static void main(String[] args) {
		...
		*/
		...
		// }
		// finally {
		// 	System.out.println("Whatever the situation is, I will execute");
		// }
...
class ClassA {
	...
	public void createAnotherError() throws IOException {
		// int d = 10 / 0;

		// try {
		// 	int d = 10 / 0;
		// 	System.out.println("9. After getting error");
		// }
		// catch (Exception ex) {
		// 	System.out.println("Exception occurred");
		// }
		...
		// ExceptionDemo.java:325: error: unreported exception IOException; 
		...
		// System.out.println("10. After getting error");
	}
}